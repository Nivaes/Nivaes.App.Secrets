...
public static class TestExtensions
{
    ...
    public static async Task<Project> ApplySecretsGenerator(this Project project)
    {
        var newProject = await project.RunSourceGenerator(new SecretsIncrementalGenerator());
